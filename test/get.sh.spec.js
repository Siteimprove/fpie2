...
describe('get.sh', () => {
  describe('in theory', () => {
    it('should calculate downloading Alpine release', async function () {
      ...
      assertContains(result, `Would download fpie2-alpine for Alpine from https://github.com/siteimprove/fpie2/releases/download/v1.0.0/fpie2-alpine to .`)
    })
    ...
    it('should calculate downloading Amazon Linux release', async function () {
      ...
      assertContains(result, `Would download fpie2-ubuntu for Amazon Linux from https://github.com/siteimprove/fpie2/releases/download/v1.0.0/fpie2-ubuntu to .`)
    })
    ...
    it('should calculate downloading Linux Mint release', async function () {
      ...
      assertContains(result, `Would download fpie2-ubuntu for Linux Mint from https://github.com/siteimprove/fpie2/releases/download/v1.0.0/fpie2-ubuntu to .`)
    })
    ...
    it('should calculate downloading Mac release', async function () {
      ...
      assertContains(result, `Would download fpie2-macos for Mac from https://github.com/siteimprove/fpie2/releases/download/v1.0.0/fpie2-macos to .`)
    })
    ...
    it('should calculate downloading Ubuntu release', async function () {
      ...
      assertContains(result, `Would download fpie2-ubuntu for Ubuntu from https://github.com/siteimprove/fpie2/releases/download/v1.0.0/fpie2-ubuntu to .`)
    })
  })
